...
<body>
<header>
  <h1>Grid Outage Planner: Salon</h1>
...
<main>
  ...
  <section>
    ...
    <p class="sms">Power Plan: Salon today. High risk <span id="smsWindow">loading</span>. Keep clippers/lights ready. Delay dryer if alert turns red.</p>
  </section>
</main>
<script>
